...
from matheushpmoreira.vehicle_rental_system.backend.errors import BadRequestError, UnprocessableEntityError
from matheushpmoreira.vehicle_rental_system.backend.models import (
    Customer,
    Rental,
    RentalStatus,
    Vehicle,
...
from matheushpmoreira.vehicle_rental_system.backend.repositories import (
    CustomerRepository,
    RentalRepository,
    VehicleRepository,
)
from matheushpmoreira.vehicle_rental_system.backend.services import CustomerService, RentalService, VehicleService
