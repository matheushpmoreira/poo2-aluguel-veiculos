...
from matheushpmoreira.vehicle_rental_system.backend.errors import UnprocessableEntityError

from matheushpmoreira.vehicle_rental_system.backend.models.customer import Customer
from matheushpmoreira.vehicle_rental_system.backend.models.vehicle import Vehicle
