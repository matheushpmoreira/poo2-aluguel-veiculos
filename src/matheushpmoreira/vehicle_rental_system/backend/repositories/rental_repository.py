...
from matheushpmoreira.vehicle_rental_system.backend.errors import NotFoundError, UnprocessableEntityError
from matheushpmoreira.vehicle_rental_system.backend.models.rental import Rental
