...
from matheushpmoreira.vehicle_rental_system.frontend.admin import AdminPanel
from matheushpmoreira.vehicle_rental_system.frontend.public import PublicPanel
