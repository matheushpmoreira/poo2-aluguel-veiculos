...
from clivet.backend.errors import ConflictError, NotFoundError, UnprocessableEntityError
from clivet.backend.models.vehicle import Vehicle, VehicleStatus, VehicleType
from clivet.backend.repositories.vehicle_repository import VehicleRepository
