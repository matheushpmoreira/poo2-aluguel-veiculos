...
from clivet.backend.errors import BadRequestError, UnprocessableEntityError
from clivet.backend.models import (
    Customer,
    Rental,
    RentalStatus,
    Vehicle,
...
from clivet.backend.repositories import (
    CustomerRepository,
    RentalRepository,
    VehicleRepository,
)
from clivet.backend.services import CustomerService, RentalService, VehicleService
