...
from clivet.backend.models import Customer, Rental, Vehicle, VehicleStatus, VehicleType

from clivet.frontend.choices import Choice
from clivet.frontend.labels import rental_status_label, vehicle_status_label, vehicle_type_label
