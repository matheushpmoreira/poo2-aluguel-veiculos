...
from clivet.backend.models import Rental, Vehicle, VehicleStatus

from clivet.frontend.base import Action, BaseFrame
from clivet.frontend.choices import (
    ChoiceBox,
    vehicle_status_choices,
    vehicle_status_filter_choices,
    vehicle_type_choices,
)
from clivet.frontend.formatters import (
